...
public class LowLevelKeywords {
	...
	public void openBrowser(String browserType) {
		...
		try {
			...
			case "edge":
				...
				System.setProperty("webdriver.edge.driver", Utilities.fileAbsolutePath() + "Browsers/Win/MicrosoftWebDriver.exe");
	...
	*/
	...
	public String verifyText(String EleType,String EleLocator, String testData) {
		...
		String textToVerify = driver.findElement(getByType(EleType,EleLocator)).getText().trim();
	...
	public String verifyMultilineText(String EleType,String EleLocator, String testData) {
		...
		String textToVerify = driver.findElement(getByType(EleType,EleLocator)).getText();
	...
	public String verifyValue(String EleType,String EleLocator, String testData) {
		testData = testData.trim();
		String textToVerify = driver.findElement(getByType(EleType,EleLocator)).getAttribute("value").trim();
	...
	public String readText(String EleType,String EleLocator) {
		...
		String text = driver.findElement(getByType(EleType,EleLocator)).getAttribute("value");
		return text;
	}
	...
	public void dragAndDrop(String EleType,String EleLocator, String text) {
		...
		try {
			...
			WebElement sourceElement = driver.findElement(getByType(EleType,EleLocator));
			WebElement destinationElement = driver.findElement(getByType(splitElement[0],splitElement[1]));
	...
	public void selectList(String EleType,String EleLocator, String text) {
		...
		// OP: N/A
		Select dropDown = new Select(driver.findElement(getByType(EleType,EleLocator)));
	...
	public void selectByIndex(String EleType,String EleLocator, String index) throws NumberFormatException {
		...
		WebElement dropDown = driver.findElement(getByType(EleType,EleLocator));
	...
	public void clickCheckbox(String EleType,String EleLocator, String text) throws InterruptedException {
		WebElement checkbox = driver.findElement(getByType(EleType,EleLocator));
		Thread.sleep(2000);
	...
	public String getText(String EleType,String EleLocator) {
		/*
		String text = driver.findElement(getByType(EleType,EleLocator)).getText();
